...
const makepdf=asyncHandle(async(id,callback)=> {
  ...
  .populate("cart.products.product", "_id brand description price ");
 ...
 const da=cartTotal.cart.products.map((item)=>{
    ...
    *[contenteditable]:hover, *[contenteditable]:focus, td:hover *[contenteditable], td:focus *[contenteditable], img.hover { background: #DEF; box-shadow: 0 0 1em 0.5em #DEF; }
    ...
    <article>
      ...
      <table class="balance">
        <tr>
          ...
          <td><span data-prefix></span><span>${products.cartTotal}</span></td>
        </tr>
        <tr>
    ...
    await page.pdf({ path: `${id}example.pdf`, format: 'A4' });
  
    await browser.close();
    console.log(`PDF saved to ${id}example.pdf`);
    callback(id)
