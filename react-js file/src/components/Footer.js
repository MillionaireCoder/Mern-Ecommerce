    ...
    <>
      <footer className="py-1"  >
        <div className="container-xxl" >
          <div className="row d-flex align-items-center p-0 justify-content-between">
  ...
  <BsYoutube className="fs-4" />
            ...
            <div className="col-sm-3 mb-4">
              ...
              <div className="footer-links d-flex flex-column">
                <Link to="/app/privacy-policy" className="text-white py-sm-1  mb-1">Privacy Policy</Link>
                <Link to="/app/refund-policy" className="text-white py-sm-1  mb-1">Refund Policy</Link>
                <Link to="/app/shipping-policy" className="text-white py-sm-1  mb-1">Shipping policy</Link>
                <Link to="/app/term-conditions" className="text-white py-sm-1  mb-1">Terms & Conditions</Link>
                <Link to="/app/blogs" className="text-white py-sm-1  mb-1">Blogs</Link>
              </div>
            </div>
            <div className="col-sm-3 mb-3">
              <h5 className="text-white mb-4">Account</h5>
              <div className="footer-links d-flex flex-column">
                <Link  className="text-white py-sm-1  mb-1" to="/app/about">About us</Link>
                <Link  className="text-white py-sm-1  mb-1"to="/app/contact">FAQ</Link>
                <Link  className="text-white py-sm-1  mb-1" to="/app/contact">Contact us</Link>
              </div>
            </div>
            <div className="col-sm-2 mb-3">
              <h5 className="text-white mb-4">Account Links</h5>
              <div className="footer-links d-flex flex-column">
                <Link className="text-white py-sm-1  mb-1" to="/app/product" onClick={()=>{
 dispatch(setQueryParams({ param: "search", value: "Laptop" }));


                  }}>Laptops</Link>
                <Link className="text-white py-sm-1  mb-1" to="/app/product" onClick={()=>{
 dispatch(setQueryParams({ param: "search", value: "Headphone" }));


                  }}>Headphones</Link>
                <Link className="text-white py-sm-1  mb-1" to="/app/product" onClick={()=>{
 dispatch(setQueryParams({ param: "search", value: "Tablet" }));
