...
toast.success("Register Succesfully")
    ...
    const{isError,isLoading,isSuccess,message}=authState
 ...
 <>
        ...
        <div className="container-xxl" style={{   background: `url('https://blog.hubspot.com/hs-fs/hubfs/ecommerce%20marketing.jpg?width=595&height=400&name=ecommerce%20marketing.jpg')`,
